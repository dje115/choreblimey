 ...
 * 
 * This script creates a test Amazon reward source for development
 * Note: You'll need to replace these with real Amazon Associates credentials
 */
...
async function setupAmazonTest() {
  ...
  try {
    ...
    console.log('4. Run the worker to test the integration')
